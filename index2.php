...
<body>
  ...
  <h1 class="bemvindo text-center text-info bg-bemvindo">Bem-vindo a Limpmax!</h1>
  ...
  <section id="servico">
        <div class="container">
            <div class="title">
                <h2>Sobre o nosso serviço como funciona e tal</h2>
                        ...
                        <div class="fatos">
                            <div class="icon">
                                ...
                                <div class="fatos-contador text-light">
                                    <h4>Nos utilizamos um produto que tira acaro ruim fodse</h4>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="fatos">
                            <div class="icon">
                                ...
                                <div class="fatos-contador text-light">
                                    <h4>Nos utilizamos extratora que nao danifica fkkodfcucuucucblblalal blalblalblalbla</h4>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="benef-fatos">
                            <div class="icon-beneficio">
                                ...
                                <div class="fatos-contador">
                                    <p>Respire melhor produto ruim</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="benef-fatos">
                            <div class="icon-beneficio">
                                ...
                                <div class="fatos-contador">
                                    <p>produto de pessima quality</p>
                                </div>
                            </div>
                        </div>
                    </div>
  ...
  <div class="row py-2">
        <div style="text-align: center"><h2>Como entrar em contaoto</h2></div>
          <div class="col-sm-6 col-md-3 col-lg-4">
            <div class="contatinho">
              <div class="icone-contato">
              <i class="icon1 fas fa-map-marker-alt"></i>
                <div class="fatos-contato text-dark">
                  <h4>Nosso local fica na pqp e tal</h4>
                </div>
              </div>
            </div>
          </div>
          <div class="col-sm-6 col-md-3 col-lg-4">
            <div class="contatinho">
              ...
              <i class="fab fa-whatsapp"></i>
                <div class="fatos-contato text-dark">
                  <h4>So falamos pela merda do wpp</h4>
                </div>
              </div>
            </div>
          </div>
...
<div class="alert alert-primary text-center  text-center" role="alert" id="result" >
  ...
  <footer class="bg-rodape1 text-center">
    ...
    <div class="copyright">&copy; 2021 Todos os direitos reservados.</div>
            <div class="copyright">Desenvolvido por Marcus Holanda</div>
